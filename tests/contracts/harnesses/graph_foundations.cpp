...
int main(){mt19937 rng(20260829);
    ...
    {vector<tuple<int,int,long long>>edges{{0,1,LLONG_MIN},{1,2,LLONG_MIN}};auto got=zero_one_duplicate_case::difference_constraints(3,edges);if(!got||(*got)[2]!=(__int128)LLONG_MIN*2)return 14;}
