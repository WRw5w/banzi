...
\bottomrule\noalign{}
\endlastfoot
基础--1800 & 高精度/任意精度整数（BigInteger） & 纯 C++17 处理超过 \passthrough{\lstinline!__int128!} 的有符号整数四则运算、模快速幂和最大公约数。 \\
...
\item
  ``整数超过 \passthrough{\lstinline!__int128!}、超长整数四则运算''：高精度/任意精度整数（BigInteger）。
\item
